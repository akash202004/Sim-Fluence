...
export function FeaturesSectionDemo() {
  const features = [
    {
      title: "Simulate Human Reactions",
      description:
    ...
    {
      title: "Predict Content Virality",
      description:
    ...
    {
      title: "Generate Realistic Feedback",
      description:
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          Our AI-powered content testing platform uses agent-based simulation and social graph modeling to forecast how real audiences might react to your content before you publish it.
        </p>
      </div>
